...
export default {
  ...
  watch: {
    question(newQuestion) { // se o campo de pergunta mudar essa função sera executada
      if (newQuestion.indexOf('?') > -1) { // se o ultimo caracter for ? dai vai executar a função abaixo
